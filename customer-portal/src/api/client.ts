 ...
 * setup needed, and the Django session cookie (customer_user_id lives in
 * request.session, apps/accounts/authentication.py CustomerSessionAuthentication)
 ...
 * readCsrfToken() below reads the cookie Django's CSRF machinery sets once
 * a session exists.
 */
